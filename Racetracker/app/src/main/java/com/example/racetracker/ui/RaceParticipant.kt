...
class RaceParticipant(
    ...
    /**
     * Simulates the participant's progress in the race.
     * This function suspends during the delay and updates progress gradually.
     */
    suspend fun run() {
        while (currentProgress < maxProgress) {
            delay(progressDelayMillis) // suspend for given delay
            currentProgress += progressIncrement // increase progress
        }
    }
}
 ...
 * calculates the progress factor to satisfy the indicator requirements.
 */
